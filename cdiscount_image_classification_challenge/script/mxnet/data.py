...
def add_data_args(parser):
    ...
    data.add_argument('--data-train-dir', type=str, help='the training data dir')
    data.add_argument('--data-train-list', type=str, help='the training data list')
    data.add_argument('--data-val-dir', type=str, help='the validation data dir')
    data.add_argument('--data-val-list', type=str, help='the validation data list')
