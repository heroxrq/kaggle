...
def load_data_and_labels(label_type):
    """
    Loads comment_text and label data from files, splits the sentences into words.
    """
    comment_texts, labels = get_train_comment_text_and_label(label_type)
    x_text = [clean_str(comment_text) for comment_text in comment_texts]
